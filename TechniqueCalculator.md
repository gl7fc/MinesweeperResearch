...
- Lv1-1 (埋めるだけ) を全探索し、解けるセルがあれば確定。

- 解けなければ Lv1-2/1-3 (包含) を試す。

- 解けなければ Lv1-4 (共通) を試す。

- それでも解けなければ Lv2 (背理法) を試す。
...
### 例: 
{セルA, セルB, セルC} に地雷は残り 1個

初期状態では、盤面上の各数字ヒントがそれぞれ1つの Region となる。推論が進むにつれて、領域の差分や共通部分から新しい Region が生成される。
